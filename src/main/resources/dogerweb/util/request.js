...
const rootIp = "192.168.4.17";
const domain = "http://" + rootIp + ":6688";
...
const api = {
	...
	test(reqObj = {}) {
		reqObj.url = "http://" + "192.168.4.15:7788" + "/getBaseTabType";
		return yajax_notoken(reqObj);
	},
	toAddCargo(reqObj = {}) {
		reqObj.url = domain + "/addCargo";
		return yajax_notoken(reqObj);
	},
	toSale(reqObj = {}) {
		reqObj.url = domain + "/sale";
		return yajax_notoken(reqObj);
	},
	toAddStockpile(reqObj = {}) {
		reqObj.url = domain + "/updateStockpile";
		return yajax_notoken(reqObj);
	},
	toSearchCargo(reqObj = {}) {
		reqObj.url = domain + "/cargo";
		return yajax_notoken(reqObj);
	},
	deviceComp(reqObj = {}) {
