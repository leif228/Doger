...
import com.dog.doger.app.framework.constant.SystemConstant;
...
public class PubFun {
	...
	public static void checkFileExists(String filePath) {
		com.dog.doger.app.business.util.PubFun.isNull(filePath, SystemConstant.DATA_ILLEGALITY_CODE);
	...
	public static String getFileSuffix(String fileName) {
		com.dog.doger.app.business.util.PubFun.isNull(fileName, SystemConstant.DATA_ILLEGALITY_CODE);
	...
	public static String removeTheLastOne(String str) {
		com.dog.doger.app.business.util.PubFun.isNull(str, SystemConstant.DATA_ILLEGALITY_CODE);
	...
	public static String generateRandomNumbersMax10(int len) {
		com.dog.doger.app.business.util.PubFun.isNull(len, SystemConstant.DATA_ILLEGALITY_CODE);
		if (len > INT_10) {
			throw new CustomException(ErrorEnum.GATEWAY_ERROR);
		}
