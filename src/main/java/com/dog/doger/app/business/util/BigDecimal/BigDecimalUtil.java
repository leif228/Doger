package com.dog.doger.app.business.util.BigDecimal;


import com.dog.doger.app.business.util.PubFun;
...
public class BigDecimalUtil {
    ...
    public static BigDecimal multiply(Object v1, Object v2, int scale) {
        return com.dog.doger.app.business.util.BigDecimal.BigDecimalUtil.round(PubFun.ObjectToBigDecimal(v1).multiply(PubFun.ObjectToBigDecimal(v2)), scale);
    }
    ...
    public static BigDecimal multiplyPpt(Object v1, Object v2, int scale) {
        return com.dog.doger.app.business.util.BigDecimal.BigDecimalUtil.round(PubFun.ObjectToBigDecimal(v1).multiply(PubFun.ObjectToBigDecimal(v2).divide(new BigDecimal(100))), scale);
    }
    ...
    public static boolean moreThanZero(Object bd) {
    	return com.dog.doger.app.business.util.BigDecimal.BigDecimalUtil.eq(bd, BigDecimal.ZERO) == 1;
    }
    ...
    public static boolean eqZero(Object bd) {
    	return com.dog.doger.app.business.util.BigDecimal.BigDecimalUtil.eq(bd, BigDecimal.ZERO) == 0;
    }
