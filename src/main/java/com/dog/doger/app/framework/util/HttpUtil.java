package com.dog.doger.app.framework.util;
...
import com.dog.doger.app.framework.util.StrKit;
...
public class HttpUtil {
    ...
    private static String getContent(HttpServletRequest request) throws UnsupportedEncodingException {
        ...
        if (com.dog.doger.app.framework.util.StrKit.isBlank(method)) {
            return null;
        }
    ...
    private static String getGetParameter(HttpServletRequest request) throws UnsupportedEncodingException {
        ...
        for (String s : split) {
            if (com.dog.doger.app.framework.util.StrKit.notBlank(s) && s.contains("=")) {
                String[] val1 = s.split("=");
                if (val1.length == 2) {
                    String key = val1[0];
                    String value = val1[1];
                    if (com.dog.doger.app.framework.util.StrKit.notBlank(key) && com.dog.doger.app.framework.util.StrKit.notBlank(value))
                        map.put(key, value);
                }
            }
        }
...
//    }
    ...
    private static String getPostParameter(HttpServletRequest request) {
        ...
        if (map.isEmpty()) {
            ...
            json = com.dog.doger.app.framework.util.StrKit.notBlank(applicationJSONStr) ? JSON.parseObject(applicationJSONStr) : json;
        } else {
