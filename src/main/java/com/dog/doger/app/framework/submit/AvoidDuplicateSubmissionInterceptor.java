package com.dog.doger.app.framework.submit;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.dog.doger.app.framework.result.GeneralResult;
import com.dog.doger.app.framework.submit.Token;
...
public class AvoidDuplicateSubmissionInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		//获取到方法上的注解
		com.dog.doger.app.framework.submit.Token annotation = null;
		try{
			annotation = getAnnotation(handler, com.dog.doger.app.framework.submit.Token.class);
		}catch (Exception e){
			return true;
		}
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		if(!(handler instanceof ResourceHttpRequestHandler)){
			//获取到方法上的注解
			try{
				com.dog.doger.app.framework.submit.Token annotation = getAnnotation(handler, Token.class);
